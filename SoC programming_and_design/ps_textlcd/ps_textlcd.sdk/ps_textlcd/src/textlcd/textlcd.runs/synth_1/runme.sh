...
HD_PWD='C:/2014104101/textlcd/textlcd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log textlcd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source textlcd.tcl
