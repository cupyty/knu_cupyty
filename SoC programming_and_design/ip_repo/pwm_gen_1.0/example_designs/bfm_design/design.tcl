...
set_property -name {xsim.simulate.runtime} -value {100ms} -objects [get_filesets sim_1]
	...
	set offset_file "${bd_path}/pwm_gen_v1_0_tb_include.svh"
	set fp [open $offset_file "w"]
	puts $fp "`ifndef pwm_gen_v1_0_tb_include_vh_"
	puts $fp "`define pwm_gen_v1_0_tb_include_vh_\n"
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores xilinx.com:user:pwm_gen:1.0]]]]
set test_bench_file ${ip_path}/example_designs/bfm_design/pwm_gen_v1_0_tb.sv
...
for { set i 1 } { 1 } { incr i } {
	set design_name "pwm_gen_v1_0_bfm_${i}"
...
remove_files -quiet -fileset sim_1 pwm_gen_v1_0_tb_include.vh
import_files -fileset sim_1 -norecurse -force $interface_address_vh_file
set_property top pwm_gen_v1_0_tb [get_filesets sim_1]
