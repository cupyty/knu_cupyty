...
HD_PWD='C:/2014104101/textlcd/textlcd.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log textlcd.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source textlcd.tcl -notrace
