...
HD_PWD='C:/2014104101/pwm_test_4/pwm_test_4.runs/system_pwm_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_pwm_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_pwm_gen_0_0.tcl
